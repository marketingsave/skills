...
description: "Segments the existing customer base by value (RFM scoring), behavior (usage tiers), or needs, then defines tailored communication cadence, offers, and service level per segment. Use when segmenting an existing customer base, applying RFM, identifying Champions / At-Risk / Dormant groups, tiering service by value, or building segment migration tracking."
...
- Narrative customer personas for copy/content → `customer-success/customer-persona`
- Strategic / pre-sale Ideal Customer Profile (targeting, GTM) → `estrategia/icp`
- Market research or TAM-SAM-SOM → `estrategia/market-research`
- Lead scoring

This skill is for **segmenting your existing customer base** based on behavioral / value / lifecycle data.

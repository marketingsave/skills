...
description: "Calculates customer lifetime value (CLV / LTV) with segmentation, margin adjustment, CAC:LTV ratio, payback period, sensitivity analysis, and retention investment recommendations. Use when determining how much a customer is worth over time, setting a max acquisition budget, deciding how much to invest in retention, or modeling LTV for subscription / e-commerce / services businesses."

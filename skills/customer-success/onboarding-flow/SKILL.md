...
description: "Designs customer onboarding sequences (days 1-30 post-purchase) with welcome emails, first-action prompts, milestone triggers, check-ins, and success checkpoints targeting first-win within 7 days. Use when building or fixing onboarding, reducing early churn, speeding time-to-value, standardizing the post-purchase experience, or diagnosing drop-off in the first 30 days."

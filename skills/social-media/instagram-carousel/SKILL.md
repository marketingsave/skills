...
Every slide must earn the swipe. If a slide fails to add value or build curiosity, the reader stops — and Instagram's algorithm uses carousel completion and saves as primary ranking signals, so weak middle slides sink the entire post's reach.

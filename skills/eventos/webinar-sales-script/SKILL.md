...
description: "Creates slide-by-slide webinar sales scripts with teaching blocks, the teach→pitch pivot, value stack, objection handling, and live-attendee urgency mechanics. Use when a user is running a lead-gen or pitch-heavy webinar that needs an offer script engineered for conversion — not a pure educational webinar, and deeper on the pitch than what event-planner (webinar mode) delivers."
allowed-tools:
  - Read
  - Write
metadata:
...
Teach something genuinely valuable first, then show why your paid offer is the fastest path to the full result. The teaching earns the right to pitch — attendees who receive real value are primed to buy the deeper transformation, while attendees who feel baited-and-switched disengage before the offer slide. Design the educational content to stand on its own merits, then position the offer as the natural accelerator.

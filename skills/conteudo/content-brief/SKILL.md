...
A great brief makes great writing inevitable. If you have to heavily edit the first draft, the brief failed — not the writer. Everything unclear in the brief becomes a judgment call the writer makes for you, and those calls drift toward generic.
...
Gate: present the assembled brief to the user for approval before finalizing. Acceptable approvals: "looks good," "yes," "send it," or similar. If the user flags a gap, revise the relevant section only — do not regenerate the whole brief.
...
- [ ] Audience, tone, and structure are all present (these three prevent 90% of revision cycles)
- [ ] Word count is a range, not a fixed number
- [ ] Primary keyword and 3-5 secondary keywords listed (or flagged as tentative)
- [ ] At least 2 reference links with notes on what to emulate and what to avoid
- [ ] "What NOT to Do" section has concrete items (not vague warnings)
- [ ] CTA and delivery format are specified
- [ ] Brief fits in under 2 pages
...
- Audience, tone, and structure are non-negotiable — missing any of the three accounts for most revision cycles, because the writer ends up guessing the one you left out
- Include specific examples of good and bad approaches (a writer calibrates faster from one counter-example than from three pages of rules)
- Keep briefs under 2 pages — long briefs don't get read, and unread instructions produce off-brief drafts
- Use a word count range, not a fixed number (e.g., 1,800-2,200, not 2,000) — fixed numbers trigger padding or cuts that hurt the piece
- Always specify what not to do — writers need guardrails, not just goals, because "good" has too many valid directions

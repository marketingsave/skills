...
**DO NOT** use this skill for full website audits, SEO/technical audits, or building a new landing page from scratch. For writing new landing page copy, use `copywriting/landing-page-copy`. For technical SEO, use `seo/technical-seo-checklist`.

---

## Operating Rules

- Every recommendation must tie to a measurable conversion outcome (signup, purchase, booking) — reject aesthetic-only feedback.
- Match the audit lens to the traffic source: cold ad traffic needs stronger above-the-fold and risk reversal; warm email traffic can lean on prior context.
- Cap prioritized output at the top 5 highest-leverage changes — dumping 20+ recommendations guarantees nothing ships.

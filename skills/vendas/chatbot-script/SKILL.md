...
A chatbot should resolve simple questions instantly and route complex ones to humans gracefully. The worst chatbot experience is one that loops endlessly without helping — users lose patience when the bot cannot answer and cannot escalate. Design for fast resolution on common scenarios and graceful handoff on everything else.

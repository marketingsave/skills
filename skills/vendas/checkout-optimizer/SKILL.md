...
Every extra field, click, or page in checkout is a reason for the shopper to leave. The guiding discipline is to remove everything that does not directly contribute to completing the purchase — each element must justify its friction cost against its conversion benefit.

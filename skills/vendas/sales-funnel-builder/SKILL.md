...
A funnel is only as strong as its weakest stage. The discipline is to map every step, measure every transition, and fix the biggest drop-off first before optimizing anything else. Adding more traffic to a broken funnel wastes budget; diagnosing conversion at each stage is where the leverage lives.
...
## Example: Online Course Creator — $297 Productivity Course

**Brief:** Core offer = $297 course on deep-work for knowledge workers. Traffic from LinkedIn organic + YouTube Shorts. No existing funnel. Has email list of 800.

**Full Funnel Map:**

**Stage 1 — Awareness:** LinkedIn posts (3/week) + YouTube Shorts (5/week) teaching deep-work tactics. CTA in bio: "Free 7-day deep-work starter kit."
- Benchmark: 2-4% profile-to-click rate.

**Stage 2 — Capture:** Landing page `/starter-kit` → "Get the 7-day Deep Work Starter Kit (free)." Single field: email. Thank-you page delivers PDF + Day 1 email.
- Copy direction: headline states outcome in 7 days; 3 bullets on what's inside; social proof (2 testimonials).
- Tech: ConvertKit form + landing page. Tracking: UTM on every LinkedIn/YouTube link.
- Benchmark: 35% opt-in (warm traffic); fix headline first if under 20%.

**Stage 3 — Nurture:** 7-day email sequence (one tactic/day). Day 8: soft pitch for the $297 course. Days 10, 12, 14: case study, objection-handling email, deadline email.
- Benchmark: 40% open rate, 6% click rate by day 3.

**Stage 4 — Convert:** Sales page for "Deep Work OS" — $297.
- Copy direction: pain (context-switching cost), solution (4-module system), proof (3 case studies), price anchor ($2K coaching vs $297 course), guarantee (14-day refund).
- Benchmark: 3-5% email-to-sale on launch week.

**Stage 5 — Maximize:** Order bump at checkout: "Add the Notion Deep Work Dashboard — $27" (target 35% take rate). Post-purchase upsell: "1:1 Focus Audit — $197" (target 15% take rate).

**Stage 6 — Retain:** 5-email onboarding (Day 0, 1, 3, 7, 30) walking through modules. Day 45: invite to $97/mo community (target 10% conversion).

**Funnel Math (month 3, steady state):**

```
2,000 LP visits/month
× 32% opt-in = 640 new leads
× 4% email-to-sale = 26 course sales × $297 = $7,722
× 35% order bump ($27) = 9 bumps = $243
× 15% upsell ($197) = 4 upsells = $788
× 10% community (of month-old cohort) = 3 × $97 = $291/mo recurring
─────────
Month-3 revenue: $9,044 + $291 MRR
Revenue per lead: $14.11
```

**Implementation Priority:**
1. Sales page + checkout + order bump (you must have the offer before the funnel)
2. Starter Kit PDF + landing page + 7-email sequence
3. LinkedIn/YouTube content cadence
4. Upsell page + community offer (month 2+)

**Tech Stack:** ConvertKit (email + LP), ThriveCart (checkout + bump + upsell), Circle (community), Fathom (analytics).

**First optimization after launch:** if email-to-sale < 2%, fix the sales page headline and guarantee before touching traffic.

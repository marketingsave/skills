...
Every test needs a hypothesis written before it starts. If you cannot state what you expect the variant to do and why you expect it, you are guessing, not testing — and guessing produces results you cannot learn from, even when the numbers look good.

---
name: meeting-agenda
description: "Builds a PRE-MEETING agenda with time-boxed topics, explicit decision items, owners, discussion prompts, and a pre-meeting checklist. Use when the user has a meeting coming up and needs a structured agenda to send in advance. Not for meeting notes or post-meeting recaps."
...
Every meeting exists either to make decisions or to align on information. When the agenda does not name the specific decisions that need to be made, the meeting will end without making them — the conversation drifts toward whatever is easiest to discuss, not whatever is most important to resolve.

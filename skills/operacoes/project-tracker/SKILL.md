...
allowed-tools: [Read, Write, mcp__claude_ai_Notion__notion-create-database, mcp__claude_ai_Notion__notion-create-pages, mcp__claude_ai_Notion__notion-search, mcp__claude_ai_Notion__notion-fetch]
metadata:
...
- A one-shot launch checklist (no Notion, no persistence) → use `launch-checklist`
...
See `references/examples.md` for two worked end-to-end examples (website redesign with a team, and solo course launch), including full task seed data by phase.

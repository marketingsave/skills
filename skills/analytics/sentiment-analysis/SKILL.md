...
Sentiment is a leading indicator. Declining sentiment predicts churn, negative reviews, and revenue loss weeks or months before they show up in financials — by the time revenue drops, the customers who would have warned you have already left. Treat sentiment shifts with the same urgency as a P&L anomaly.
...
- **< 100 items:** manual classification in a spreadsheet is fastest.
- **100–1,000 items:** use an LLM batch prompt (classify + theme-tag in one pass).
- **1,000+ items or ongoing:** dedicated tool (Brandwatch, Mention, Sprout Social, or a custom pipeline with embeddings).

### Report Template

```
# Sentiment Analysis — [Source] — [Date Range]

## Snapshot
Positive: X% | Neutral: Y% | Negative: Z%  (n = N)

## By Theme
| Theme | Volume | Sentiment | Trend | Priority |

...
Track only what you will act on. Every event and conversion goal must connect to a business decision; if nobody will change behavior based on the data, it's noise that dilutes the signal. Before adding any event to the plan, ask: "What decision will this number inform, and who makes it?" If you cannot answer both, cut it.
...
Deliver the plan as a markdown/spreadsheet table:

| Event Name | Trigger | Parameters | Category | Business Purpose | Conversion? | Value |
|-----------|---------|-----------|----------|-----------------|-------------|-------|
| `cta_click_hero` | Click on hero CTA | page_url, cta_text | Engagement | Measure hero effectiveness | No | — |
| `form_submit_contact` | Contact form submit | form_id, source | Conversion | Primary lead capture | Yes | $50 |

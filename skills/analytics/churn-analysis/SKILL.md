...
Churn is a symptom, not the disease. Every churned customer had a moment where the value they received dropped below the price they paid — the cancellation is just when they noticed. Diagnosis is about finding that moment, not reacting to the cancel click. Fix the value gap and you prevent churn; offer discounts and you only delay it while training customers to threaten leaving.

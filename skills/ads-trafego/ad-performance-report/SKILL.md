...
Every metric in the report should lead to an action. Numbers that do not inform a decision are noise — remove them or move them to an appendix so the report stays focused on what the reader will actually do next.

...
A lookalike audience is only as good as its source. A 500-person list of repeat buyers produces better lookalikes than a 50,000-person list of newsletter subscribers. Always start from the highest-value customer signal available, not the largest one.
